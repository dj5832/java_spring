...
public class PdsController {
	...
	public void regist(PdsRegistCommand registReq, HttpServletRequest req, HttpServletResponse res) throws IllegalStateException, IOException, SQLException {
	...
	private List<AttachVO> saveFile(PdsRegistCommand registReq) throws IllegalStateException, IOException{
	...
	public void remove(PdsModifyCommand modifyReq, int pno, HttpServletRequest req, HttpServletResponse res) throws SQLException, IOException {
